...
public class ReadSmsService extends Service {
	...
	public static final int READING_AUDIO_STREAM = AudioManager.STREAM_VOICE_CALL;
	  ...
	  private static final String BLUETOOTH_TIMEOUT_EXTRA = "king.muchbeer.aac.headphone.BLUETOOTH_TIMEOUT";
	  private static final String QUEUE_MESSAGE_EXTRA = "king.muchbeer.aac.headphone.QUEUE_MESSAGE";
	  private static final String START_READING_EXTRA = "king.muchbeer.aac.headphone.START_READING";
	  private static final String STOP_READING_EXTRA = "king.muchbeer.aac.headphone.STOP_READING";
